...
// This is to avoid issues with GitHub Pages' security policies.

// Import Firebase libraries directly within the script to be loaded globally.
// This is a workaround for the 'import' issue on GitHub Pages.
const firebaseAppScript = document.createElement('script');
firebaseAppScript.src = "https://www.gstatic.com/firebasejs/11.6.1/firebase-app.js";
document.head.appendChild(firebaseAppScript);

const firebaseAuthScript = document.createElement('script');
firebaseAuthScript.src = "https://www.gstatic.com/firebasejs/11.6.1/firebase-auth.js";
document.head.appendChild(firebaseAuthScript);

const firestoreScript = document.createElement('script');
firestoreScript.src = "https://www.gstatic.com/firebasejs/11.6.1/firebase-firestore.js";
document.head.appendChild(firestoreScript);

// Delay the rest of the script until Firebase is loaded
